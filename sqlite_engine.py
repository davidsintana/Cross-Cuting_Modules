...
class DataBaseTable(DataBase):
    ...
    def __init__(self, _name, _attributes, _primary_index, _db_path, _log_file_object):
        super().__init__(_db_path, _log_file_object)
    ...
    def insert(self, _entry_values):
        ...
        query += ")"
        self.log_file.write("Execute=" + query + str(_entry_values))
